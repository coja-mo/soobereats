...
export function extractEntities(text) {
    ...
    // Restaurant names
    const restaurants = ['aurora', 'pino', 'tandoori', 'sandro', 'muio', 'uncle gino', 'solo trattoria'];
...
const DEMO_ORDERS = {
    'ORD-4012': { restaurant: "Pino's Fresh Market", items: ['Organic 2% Milk', 'Sourdough Bread', 'Local Honey'], status: 'en_route', driver: 'Marcus T.', vehicle: 'Black GMC Hummer EV', eta: '4 min', total: 32.47 },
