...
export const generateDispatchUnits = () => {
    ...
    const locations = ['Downtown Core', 'North End', 'East Side', 'Great Northern Rd', 'SOOber Airport (YAM)', 'Base Station', 'Algoma U', 'Sault College', 'Pine St Hub', 'Station Mall'];
...
export const INCIDENT_SEED = [
    ...
    { type: 'dispatch', message: 'Unit R-005 (BYD Atto 3) en route to pickup at Pino\'s Fresh Grocery.' },
