...
export const categories = [
    ...
    { id: 'sports-bar', name: 'Sports Bar', emoji: '🏈' },
...
export const restaurants = [
    ...
    // ─── HOME Bakery ──────────────────────────────────────
    {
        id: 'home-bakery', name: 'HOME Bakery', category: 'Bakery', categoryId: 'bakery',
        image: '/restaurants/homebakery.png', coverColor: '#1a1510', logo: '🍞',
        rating: 4.8, reviewCount: 215, deliveryTime: '15-25', distance: 1.5, promo: null, isOpen: true, isFeatured: true,
        address: 'Downtown, Sault Ste. Marie, ON',
        description: 'Artisan breads, pastries, and specialty coffee. Everything baked fresh daily from scratch with locally sourced ingredients.',
        menu: [
            { id: 'hb1', name: 'Sourdough Loaf', description: 'Long-fermented wild yeast sourdough, crusty and tangy', price: 8.99, category: 'Breads' },
            { id: 'hb2', name: 'Butter Croissant', description: 'Flaky, laminated with European butter, baked golden', price: 4.99, category: 'Pastries' },
            { id: 'hb3', name: 'Cinnamon Bun', description: 'Soft pull-apart roll with cream cheese glaze', price: 5.49, category: 'Pastries' },
            { id: 'hb4', name: 'Breakfast Sandwich', description: 'Egg, aged cheddar, and bacon on house focaccia', price: 10.99, category: 'Breakfast' },
            { id: 'hb5', name: 'Seasonal Fruit Tart', description: 'Buttery pastry shell with custard and fresh fruit', price: 6.99, category: 'Desserts' },
            { id: 'hb6', name: 'Latte', description: 'Double-shot espresso with steamed milk', price: 5.49, category: 'Coffee' },
            { id: 'hb7', name: 'Focaccia Slab', description: 'Rosemary sea salt focaccia, perfect for sharing', price: 7.99, category: 'Breads' },
            { id: 'hb8', name: 'Pain au Chocolat', description: 'Flaky pastry rolled with dark chocolate batons', price: 5.49, category: 'Pastries' },
        ],
    },

    // ─── Superior Home Bakery ──────────────────────────────────────
    {
        id: 'superior-home-bakery', name: 'Superior Home Bakery', category: 'Bakery', categoryId: 'bakery',
        image: '/restaurants/superiorhome.png', coverColor: '#1a1208', logo: '🥧',
        rating: 4.7, reviewCount: 340, deliveryTime: '15-25', distance: 2.8, promo: null, isOpen: true, isFeatured: false,
        address: 'Sault Ste. Marie, ON',
        description: 'A Soo institution. Finnish-Canadian heritage bakery famous for pulla, pies, and fresh bread baked from family recipes.',
        menu: [
            { id: 'shb1', name: 'Pulla (Finnish Cardamom Bread)', description: 'Traditional braided sweet bread with cardamom', price: 7.99, category: 'Breads' },
            { id: 'shb2', name: 'Blueberry Pie', description: 'Double-crust pie with wild Northern Ontario blueberries', price: 16.99, category: 'Pies' },
            { id: 'shb3', name: 'Rye Bread Loaf', description: 'Dense Finnish-style dark rye, sliced', price: 6.99, category: 'Breads' },
            { id: 'shb4', name: 'Cinnamon Twist', description: 'Flaky pastry twisted with butter-cinnamon filling', price: 3.99, category: 'Pastries' },
            { id: 'shb5', name: 'Meat Pie', description: 'Savoury ground beef and rice pie in pastry crust', price: 5.99, category: 'Savoury' },
            { id: 'shb6', name: 'Nisu Buns (6 pack)', description: 'Sweet cardamom rolls, soft and pillowy', price: 9.99, category: 'Buns' },
        ],
    },

    // ─── Kasdan Co. ──────────────────────────────────────
    {
        id: 'kasdan-co', name: 'Kasdan Co.', category: 'Bar & Lounge', categoryId: 'bar-lounge',
        image: '/restaurants/kasdan.png', coverColor: '#0e0a1a', logo: '🍸',
        rating: 4.6, reviewCount: 178, deliveryTime: '25-40', distance: 1.0, promo: null, isOpen: true, isFeatured: false,
        address: 'Downtown, Sault Ste. Marie, ON',
        description: 'Modern cocktail bar and eatery. Craft cocktails, elevated small plates, and a moody downtown atmosphere.',
        menu: [
            { id: 'kc1', name: 'Smoked Old Fashioned', description: 'Bourbon, smoked maple syrup, Angostura, orange peel', price: 16.99, category: 'Cocktails' },
            { id: 'kc2', name: 'Charcuterie Board', description: 'Cured meats, artisan cheeses, pickles, and crostini', price: 22.99, category: 'Shareables' },
            { id: 'kc3', name: 'Truffle Mac & Cheese', description: 'Rich three-cheese mac with black truffle oil and panko', price: 15.99, category: 'Mains' },
            { id: 'kc4', name: 'Tuna Tartare', description: 'Fresh ahi tuna with avocado, sesame, and wonton chips', price: 18.99, category: 'Starters' },
            { id: 'kc5', name: 'Kasdan Burger', description: 'Wagyu blend patty with gruyère, caramelized onion, and aioli', price: 19.99, category: 'Mains' },
            { id: 'kc6', name: 'Espresso Martini', description: 'Vodka, fresh espresso, coffee liqueur, vanilla', price: 15.99, category: 'Cocktails' },
        ],
    },

    // ─── Top Hat ──────────────────────────────────────
    {
        id: 'top-hat', name: 'Top Hat', category: 'Pub & Grill', categoryId: 'pub',
        image: '/restaurants/tophat.png', coverColor: '#1a0a14', logo: '🎩',
        rating: 4.3, reviewCount: 420, deliveryTime: '25-40', distance: 1.2, promo: null, isOpen: true, isFeatured: false,
        address: 'Downtown, Sault Ste. Marie, ON',
        description: 'Legendary downtown music venue and pub. Great wings, cold beer, and live entertainment every weekend.',
        menu: [
            { id: 'th1b', name: 'Top Hat Wings (1 lb)', description: 'Crispy wings, choice of over 20 sauces', price: 15.99, category: 'Wings' },
            { id: 'th2b', name: 'Top Hat Burger', description: 'Classic half-pound burger with lettuce, tomato, and pickles', price: 16.99, category: 'Burgers' },
            { id: 'th3b', name: 'Nachos Grande', description: 'Loaded with beef, cheese, jalapeños, salsa, and sour cream', price: 16.99, category: 'Appetizers' },
            { id: 'th4b', name: 'Fish & Chips', description: 'Beer-battered haddock with fries and coleslaw', price: 17.99, category: 'Mains' },
            { id: 'th5b', name: 'Quesadilla', description: 'Grilled tortilla with chicken, peppers, and cheddar', price: 14.99, category: 'Mains' },
        ],
    },

    // ─── Nova Grill ──────────────────────────────────────
    {
        id: 'nova-grill', name: 'Nova Grill', category: 'Canadian', categoryId: 'canadian',
        image: '/restaurants/novagrill.png', coverColor: '#1a1008', logo: '⭐',
        rating: 4.5, reviewCount: 256, deliveryTime: '25-40', distance: 3.5, promo: null, isOpen: true, isFeatured: false,
        address: 'Sault Ste. Marie, ON',
        description: 'Fresh-made comfort food with generous portions. Known for big breakfasts, burgers, and all-day comfort classics.',
        menu: [
            { id: 'ng1', name: 'Nova Breakfast', description: 'Three eggs, bacon, sausage, toast, and home fries', price: 14.99, category: 'Breakfast' },
            { id: 'ng2', name: 'Nova Burger', description: 'Double patty with cheddar, lettuce, tomato, and signature sauce', price: 16.99, category: 'Burgers' },
            { id: 'ng3', name: 'Chicken Souvlaki Dinner', description: 'Grilled chicken skewers with rice, salad, and tzatziki', price: 17.99, category: 'Mains' },
            { id: 'ng4', name: 'Hot Beef Sandwich', description: 'Roast beef on white bread with gravy and fries', price: 15.99, category: 'Mains' },
            { id: 'ng5', name: 'Poutine', description: 'Fresh-cut fries, cheese curds, and house gravy', price: 11.99, category: 'Sides' },
        ],
    },

    // ─── La Ahn ──────────────────────────────────────
    {
        id: 'la-ahn', name: 'La Ahn', category: 'Vietnamese', categoryId: 'vietnamese',
        image: '/restaurants/laahn.png', coverColor: '#0e1a0a', logo: '🍜',
        rating: 4.5, reviewCount: 195, deliveryTime: '25-40', distance: 3.0, promo: null, isOpen: true, isFeatured: false,
        address: 'Sault Ste. Marie, ON',
        description: 'Authentic Vietnamese cuisine with fresh ingredients. Pho, banh mi, and spring rolls made the traditional way.',
        menu: [
            { id: 'laa1', name: 'Pho Tai (Beef Pho)', description: 'Rice noodles in rich beef broth with rare steak, bean sprouts, and herbs', price: 15.99, category: 'Pho' },
            { id: 'laa2', name: 'Banh Mi', description: 'Vietnamese baguette with pickled veggies, cilantro, and choice of protein', price: 12.99, category: 'Sandwiches' },
            { id: 'laa3', name: 'Fresh Spring Rolls (4pc)', description: 'Rice paper rolls with shrimp, vermicelli, and peanut sauce', price: 10.99, category: 'Appetizers' },
            { id: 'laa4', name: 'Bun Bo Hue', description: 'Spicy lemongrass beef noodle soup', price: 16.99, category: 'Soups' },
            { id: 'laa5', name: 'Vietnamese Iced Coffee', description: 'Strong drip coffee with sweetened condensed milk over ice', price: 5.99, category: 'Drinks' },
        ],
    },

    // ─── Bucci's Place ──────────────────────────────────────
    {
        id: 'buccis-place', name: "Bucci's Place", category: 'Italian', categoryId: 'italian',
        image: '/restaurants/buccis.png', coverColor: '#1a0e0a', logo: '🍕',
        rating: 4.4, reviewCount: 310, deliveryTime: '25-40', distance: 3.8, promo: null, isOpen: true, isFeatured: false,
        address: 'Sault Ste. Marie, ON',
        description: 'Classic Italian comfort food with homestyle cooking. Great pizza, pasta, and veal in a warm family atmosphere.',
        menu: [
            { id: 'bc1', name: 'Pepperoni Pizza (Large)', description: 'Classic pepperoni with mozzarella on house dough', price: 17.99, category: 'Pizza' },
            { id: 'bc2', name: 'Veal Parmigiana', description: 'Breaded veal with marinara, mozzarella, and pasta', price: 21.99, category: 'Mains' },
            { id: 'bc3', name: 'Spaghetti & Meatballs', description: 'Homemade meatballs in rich tomato sauce', price: 16.99, category: 'Pastas' },
            { id: 'bc4', name: 'Chicken Wings (1 lb)', description: 'Crispy wings in your choice of sauce', price: 14.99, category: 'Appetizers' },
            { id: 'bc5', name: 'Bruschetta', description: 'Toasted bread with fresh tomato, garlic, and basil', price: 10.99, category: 'Appetizers' },
        ],
    },

    // ─── Sportscentre ──────────────────────────────────────
    {
        id: 'sportscentre', name: 'Sportscentre', category: 'Sports Bar', categoryId: 'sports-bar',
        image: '/restaurants/sportscentre.png', coverColor: '#0e1214', logo: '🏈',
        rating: 4.2, reviewCount: 430, deliveryTime: '25-40', distance: 4.0, promo: null, isOpen: true, isFeatured: false,
        address: 'Sault Ste. Marie, ON',
        description: 'The ultimate spot for watching the game. Big screens, cold beer, and classic pub food done right.',
        menu: [
            { id: 'sc1', name: 'Wings (2 lbs)', description: 'Jumbo wings, choice of 20+ sauces', price: 22.99, category: 'Wings' },
            { id: 'sc2', name: 'Sportscentre Burger', description: 'Double smash patty with American cheese and pickles', price: 17.99, category: 'Burgers' },
            { id: 'sc3', name: 'Loaded Nachos', description: 'Piled high with beef, cheese, jalapeños, salsa', price: 16.99, category: 'Appetizers' },
            { id: 'sc4', name: 'Fish & Chips', description: 'Beer-battered cod with fries and coleslaw', price: 17.99, category: 'Mains' },
            { id: 'sc5', name: 'Onion Rings', description: 'Thick-cut beer-battered onion rings', price: 9.99, category: 'Sides' },
        ],
    },

    // ─── Georgie's Shawarma ──────────────────────────────────────
    {
        id: 'georgies-shawarma', name: "Georgie's Shawarma", category: 'Middle Eastern', categoryId: 'middle-eastern',
        image: '/restaurants/georgies.png', coverColor: '#1a0e08', logo: '🥙',
        rating: 4.6, reviewCount: 285, deliveryTime: '20-30', distance: 2.5, promo: null, isOpen: true, isFeatured: false,
        address: 'Sault Ste. Marie, ON',
        description: 'Fresh-made shawarma, falafel, and platters. Generous portions and authentic Middle Eastern flavours.',
        menu: [
            { id: 'gs1', name: 'Chicken Shawarma Wrap', description: 'Marinated chicken with garlic sauce, pickles, and veggies', price: 13.99, category: 'Wraps' },
            { id: 'gs2', name: 'Beef Shawarma Plate', description: 'Shaved beef with rice, salad, hummus, and pita', price: 17.99, category: 'Plates' },
            { id: 'gs3', name: 'Falafel Wrap', description: 'Crispy falafel with tahini, lettuce, and tomato', price: 11.99, category: 'Wraps' },
            { id: 'gs4', name: 'Fattoush Salad', description: 'Fresh vegetables with crispy pita and sumac dressing', price: 10.99, category: 'Salads' },
            { id: 'gs5', name: 'Combo Plate', description: 'Chicken and beef shawarma with all the sides', price: 19.99, category: 'Plates' },
        ],
    },

    // ─── Centre Ice ──────────────────────────────────────
    {
        id: 'centre-ice', name: 'Centre Ice', category: 'Sports Bar', categoryId: 'sports-bar',
        image: '/restaurants/centreice.png', coverColor: '#0a0e1a', logo: '🏒',
        rating: 4.3, reviewCount: 195, deliveryTime: '25-40', distance: 1.5, promo: null, isOpen: true, isFeatured: false,
        address: 'Downtown, Sault Ste. Marie, ON',
        description: 'Hockey-themed sports bar with great wings, draught beer, and the best spot to catch Greyhounds games.',
        menu: [
            { id: 'ci1', name: 'Centre Ice Wings (1 lb)', description: 'Crispy wings — try the Greyhound Hot sauce', price: 15.99, category: 'Wings' },
            { id: 'ci2', name: 'Hat Trick Burger', description: 'Triple-stacked sliders with three different toppings', price: 18.99, category: 'Burgers' },
            { id: 'ci3', name: 'Poutine', description: 'Hand-cut fries with cheese curds and gravy', price: 11.99, category: 'Sides' },
            { id: 'ci4', name: 'Chicken Fingers & Fries', description: 'Crispy breaded chicken strips with plum sauce', price: 14.99, category: 'Mains' },
            { id: 'ci5', name: 'Pepperoni Pizza', description: 'Classic pepperoni on thin crust', price: 15.99, category: 'Pizza' },
        ],
    },

    // ─── Manee Street Cafe & Lounge ──────────────────────────────────────
    {
        id: 'manee-street', name: 'Manee Street Cafe & Lounge', category: 'Café', categoryId: 'cafe',
        image: '/restaurants/maneestreet.png', coverColor: '#14100e', logo: '☕',
        rating: 4.4, reviewCount: 165, deliveryTime: '20-35', distance: 2.0, promo: null, isOpen: true, isFeatured: false,
        address: 'Sault Ste. Marie, ON',
        description: 'Cozy café by day, cocktail lounge by night. Specialty coffee, fresh wraps, and artisan cocktails.',
        menu: [
            { id: 'ms1b', name: 'Manee Latte', description: 'House-roasted espresso with locally sourced milk', price: 5.99, category: 'Coffee' },
            { id: 'ms2b', name: 'Avocado Toast', description: 'Sourdough with smashed avo, poached egg, and chili flakes', price: 13.99, category: 'Breakfast' },
            { id: 'ms3b', name: 'Chicken Caesar Wrap', description: 'Grilled chicken, romaine, parmesan, house dressing', price: 14.99, category: 'Wraps' },
            { id: 'ms4b', name: 'Seasonal Salad Bowl', description: 'Fresh greens with rotating seasonal toppings', price: 13.99, category: 'Bowls' },
            { id: 'ms5b', name: 'Espresso Martini', description: 'Vodka, fresh espresso, and Kahlúa', price: 14.99, category: 'Cocktails' },
        ],
    },

    // ─── Pho Max ──────────────────────────────────────
    {
        id: 'pho-max', name: 'Pho Max', category: 'Vietnamese', categoryId: 'vietnamese',
        image: '/restaurants/phomax.png', coverColor: '#1a0e08', logo: '🍜',
        rating: 4.4, reviewCount: 340, deliveryTime: '25-40', distance: 3.5, promo: null, isOpen: true, isFeatured: false,
        address: 'Sault Ste. Marie, ON',
        description: 'The Soo\'s go-to for authentic Vietnamese pho. Rich broth simmered for hours with fresh herbs and noodles.',
        menu: [
            { id: 'pm1', name: 'Pho Dac Biet (Special Pho)', description: 'Beef broth with rare steak, brisket, tripe, and tendon', price: 16.99, category: 'Pho' },
            { id: 'pm2', name: 'Pho Ga (Chicken Pho)', description: 'Clear chicken broth with tender chicken and rice noodles', price: 14.99, category: 'Pho' },
            { id: 'pm3', name: 'Vermicelli Bowl', description: 'Rice vermicelli with grilled pork, spring rolls, and fish sauce', price: 15.99, category: 'Bowls' },
            { id: 'pm4', name: 'Banh Mi Thit', description: 'Vietnamese sub with grilled pork, pickled veggies, and cilantro', price: 11.99, category: 'Sandwiches' },
            { id: 'pm5', name: 'Fried Spring Rolls (4pc)', description: 'Crispy pork and shrimp rolls with sweet chili sauce', price: 8.99, category: 'Appetizers' },
        ],
    },

    // ─── Heyden Restaurant ──────────────────────────────────────
    {
        id: 'heyden-restaurant', name: 'Heyden Restaurant', category: 'Canadian', categoryId: 'canadian',
        image: '/restaurants/heyden.png', coverColor: '#1a1510', logo: '🏡',
        rating: 4.3, reviewCount: 180, deliveryTime: '30-45', distance: 12.0, promo: null, isOpen: true, isFeatured: false,
        address: 'Heyden, ON (just north of Sault Ste. Marie)',
        description: 'Country-style family restaurant on the highway north. Big breakfasts, homestyle dinners, and fresh pies.',
        menu: [
            { id: 'hd1', name: 'Country Breakfast', description: 'Three eggs, peameal bacon, sausage, toast, and hash browns', price: 14.99, category: 'Breakfast' },
            { id: 'hd2', name: 'Hot Turkey Dinner', description: 'Roast turkey with stuffing, mashed potatoes, and gravy', price: 16.99, category: 'Mains' },
            { id: 'hd3', name: 'Liver & Onions', description: 'Pan-fried calf liver with caramelized onions and mashed', price: 15.99, category: 'Mains' },
            { id: 'hd4', name: 'Homemade Pie', description: 'Daily rotating pie — blueberry, apple, coconut cream', price: 5.99, category: 'Desserts' },
            { id: 'hd5', name: 'Clubhouse Sandwich', description: 'Triple-decker with turkey, bacon, lettuce, and tomato', price: 15.99, category: 'Sandwiches' },
        ],
    },

    // ─── Woking Chopsticks ──────────────────────────────────────
    {
        id: 'woking-chopsticks', name: 'Woking Chopsticks', category: 'Chinese', categoryId: 'chinese',
        image: '/restaurants/wokingchopsticks.png', coverColor: '#1a0808', logo: '🥢',
        rating: 4.2, reviewCount: 145, deliveryTime: '25-40', distance: 3.5, promo: null, isOpen: true, isFeatured: false,
        address: 'Sault Ste. Marie, ON',
        description: 'Wok-fired Chinese classics made fresh to order. Generous portions and fast delivery.',
        menu: [
            { id: 'wk1b', name: 'Sweet & Sour Chicken', description: 'Crispy chicken in house sweet and sour sauce', price: 14.99, category: 'Mains' },
            { id: 'wk2b', name: 'Beef & Broccoli', description: 'Tender beef stir-fried with fresh broccoli', price: 15.99, category: 'Mains' },
            { id: 'wk3b', name: 'Chicken Fried Rice', description: 'Wok-fried rice with chicken, egg, and vegetables', price: 12.99, category: 'Rice' },
            { id: 'wk4b', name: 'Chow Mein (Combo)', description: 'Stir-fried noodles with chicken, shrimp, and vegetables', price: 15.99, category: 'Noodles' },
            { id: 'wk5b', name: 'Egg Rolls (4pc)', description: 'Crispy egg rolls with plum sauce', price: 6.99, category: 'Appetizers' },
        ],
    },

    // ─── Webb's Munchies ──────────────────────────────────────
    {
        id: 'webbs-munchies', name: "Webb's Munchies", category: 'Breakfast', categoryId: 'breakfast',
        image: '/restaurants/webbs.png', coverColor: '#1a1208', logo: '🍔',
        rating: 4.1, reviewCount: 95, deliveryTime: '15-25', distance: 2.5, promo: null, isOpen: true, isFeatured: false,
        address: 'Sault Ste. Marie, ON',
        description: 'No-frills comfort food at great prices. Burgers, fries, and classic diner fare that hits the spot.',
        menu: [
            { id: 'wm1', name: 'Webb\'s Burger', description: 'Classic burger with cheese, lettuce, tomato, and pickles', price: 10.99, category: 'Burgers' },
            { id: 'wm2', name: 'Poutine', description: 'Hand-cut fries with cheese curds and gravy', price: 9.99, category: 'Sides' },
            { id: 'wm3', name: 'Hot Dog', description: 'Grilled all-beef hot dog with all the toppings', price: 6.99, category: 'Classics' },
            { id: 'wm4', name: 'Fries', description: 'Fresh-cut golden fries', price: 5.99, category: 'Sides' },
            { id: 'wm5', name: 'Milkshake', description: 'Thick hand-spun milkshake, any flavour', price: 6.99, category: 'Drinks' },
        ],
    },

    // ─── Soo Blaster ──────────────────────────────────────
    {
        id: 'soo-blaster', name: 'Soo Blaster', category: 'Breakfast', categoryId: 'breakfast',
        image: '/restaurants/sooblaster.png', coverColor: '#1a0a0e', logo: '🌮',
        rating: 4.3, reviewCount: 110, deliveryTime: '15-25', distance: 2.0, promo: null, isOpen: true, isFeatured: false,
        address: 'Sault Ste. Marie, ON',
        description: 'Quick-serve burgers, subs, and wraps. Fast, filling, and always satisfying.',
        menu: [
            { id: 'sbl1', name: 'Soo Blaster Burger', description: 'Signature double patty with secret sauce', price: 12.99, category: 'Burgers' },
            { id: 'sbl2', name: 'Chicken Sub', description: 'Grilled chicken breast on a toasted sub with veggies', price: 11.99, category: 'Subs' },
            { id: 'sbl3', name: 'Poutine', description: 'Fries, curds, and gravy — loaded', price: 10.99, category: 'Sides' },
            { id: 'sbl4', name: 'Onion Rings', description: 'Beer-battered, golden, and crunchy', price: 7.99, category: 'Sides' },
        ],
    },

    // ─── Around the Corner Cantina ──────────────────────────────────────
    {
        id: 'around-the-corner', name: 'Around the Corner Cantina', category: 'Mexican', categoryId: 'mexican',
        image: '/restaurants/aroundthecorner.png', coverColor: '#1a1208', logo: '🌮',
        rating: 4.5, reviewCount: 220, deliveryTime: '25-40', distance: 1.5, promo: null, isOpen: true, isFeatured: false,
        address: 'Downtown, Sault Ste. Marie, ON',
        description: 'Mexican-inspired cantina with fresh tacos, burritos, and margaritas. Vibrant downtown vibe with bold flavours.',
        menu: [
            { id: 'atc1', name: 'Street Tacos (3)', description: 'Corn tortillas with choice of carnitas, chicken, or steak', price: 14.99, category: 'Tacos' },
            { id: 'atc2', name: 'Loaded Burrito', description: 'Flour tortilla stuffed with rice, beans, cheese, and protein', price: 15.99, category: 'Burritos' },
            { id: 'atc3', name: 'Nachos Grande', description: 'Loaded with queso, jalapeños, pico, sour cream, and guac', price: 16.99, category: 'Shareables' },
            { id: 'atc4', name: 'Elote (Street Corn)', description: 'Grilled corn with cotija cheese, chili, and lime', price: 8.99, category: 'Sides' },
            { id: 'atc5', name: 'Churros', description: 'Crispy cinnamon-sugar churros with chocolate dipping sauce', price: 7.99, category: 'Desserts' },
            { id: 'atc6', name: 'Margarita', description: 'Classic lime margarita, fresh-squeezed', price: 12.99, category: 'Drinks' },
        ],
    },

    // ─── Pisa Pizza West ──────────────────────────────────────
    {
        id: 'pisa-pizza-west', name: 'Pisa Pizza West', category: 'Pizza', categoryId: 'pizza',
        image: '/restaurants/pisapizza.png', coverColor: '#1a0a08', logo: '🍕',
        rating: 4.2, reviewCount: 175, deliveryTime: '20-35', distance: 5.0, promo: null, isOpen: true, isFeatured: false,
        address: 'West End, Sault Ste. Marie, ON',
        description: 'West end pizza favourite. Great pies, big slices, and fast delivery to the west side of town.',
        menu: [
            { id: 'ppw1', name: 'Large Pepperoni', description: 'Classic pepperoni pizza on hand-tossed dough', price: 16.99, category: 'Pizza' },
            { id: 'ppw2', name: 'Deluxe Pizza (Large)', description: 'Pepperoni, mushrooms, green peppers, onions, and bacon', price: 19.99, category: 'Pizza' },
            { id: 'ppw3', name: 'Garlic Fingers', description: 'Cheesy garlic bread strips with donair sauce', price: 9.99, category: 'Sides' },
            { id: 'ppw4', name: 'Wings (1 lb)', description: 'Crispy wings, choice of sauce', price: 14.99, category: 'Wings' },
            { id: 'ppw5', name: 'Panzerotti', description: 'Deep-fried dough pocket stuffed with cheese and pepperoni', price: 9.99, category: 'Specialties' },
        ],
    },

    // ─── Perfecto Pizza ──────────────────────────────────────
    {
        id: 'perfecto-pizza', name: 'Perfecto Pizza', category: 'Pizza', categoryId: 'pizza',
        image: '/restaurants/perfectopizza.png', coverColor: '#1a0a08', logo: '🍕',
        rating: 4.3, reviewCount: 230, deliveryTime: '20-35', distance: 3.2, promo: null, isOpen: true, isFeatured: false,
        address: 'Sault Ste. Marie, ON',
        description: 'Consistently great pizza with generous toppings. A reliable favourite for families and late-night orders alike.',
        menu: [
            { id: 'pf1', name: 'Perfecto Deluxe (Large)', description: 'Pepperoni, mushrooms, green pepper, onion, and bacon', price: 19.99, category: 'Pizza' },
            { id: 'pf2', name: 'Hawaiian Pizza (Large)', description: 'Ham and pineapple with mozzarella', price: 17.99, category: 'Pizza' },
            { id: 'pf3', name: 'Wings (1 lb)', description: 'Crispy wings, your choice of sauce', price: 14.99, category: 'Wings' },
            { id: 'pf4', name: 'Garlic Bread with Cheese', description: 'Fresh-baked with garlic butter and melted mozzarella', price: 7.99, category: 'Sides' },
            { id: 'pf5', name: 'Panzerotti', description: 'Deep-fried dough stuffed with cheese and toppings', price: 9.99, category: 'Specialties' },
        ],
    },

    // ─── Mrs. B's West ──────────────────────────────────────
    {
        id: 'mrs-bs-west', name: "Mrs. B's West", category: 'Pizza', categoryId: 'pizza',
        image: '/restaurants/mrs-bs-west.png', coverColor: '#1f1a14', logo: '🧀',
        rating: 4.4, reviewCount: 190, deliveryTime: '25-40', distance: 5.5, promo: null, isOpen: true, isFeatured: false,
        address: 'West End, Sault Ste. Marie, ON',
        description: 'The west-end location of the beloved Mrs. B\'s. Same famous square pizzas, wings, and combos — closer to the west side.',
        menu: [
            { id: 'mbw1', name: 'Large Square Pizza', description: 'Classic square-cut pizza with your choice of toppings', price: 19.99, category: 'Pizzas' },
            { id: 'mbw2', name: 'Meat Lovers Pizza', description: 'Pepperoni, sausage, ham, and bacon', price: 22.99, category: 'Pizzas' },
            { id: 'mbw3', name: 'Chicken Wings (1 lb)', description: 'Crispy wings with your choice of sauce', price: 14.99, category: 'Wings' },
            { id: 'mbw4', name: 'Family Feast', description: 'Large 2-item pizza, 15 wings, mozza sticks, garlic breadstix', price: 42.99, category: 'Combos' },
            { id: 'mbw5', name: 'Garlic Crazy Stix', description: 'Garlic breadsticks with dipping sauce', price: 8.99, category: 'Sides' },
        ],
    },

    // ─── Water Tower Pub ──────────────────────────────────────
    {
        id: 'water-tower-pub', name: 'Water Tower Pub', category: 'Pub & Grill', categoryId: 'pub',
        image: '/restaurants/watertower.png', coverColor: '#0e1214', logo: '🍺',
        rating: 4.2, reviewCount: 310, deliveryTime: '25-40', distance: 4.5, promo: null, isOpen: true, isFeatured: false,
        address: 'Sault Ste. Marie, ON',
        description: 'Neighbourhood pub with classic comfort food. Great wings, burgers, cold beer, and a friendly local vibe.',
        menu: [
            { id: 'wt1', name: 'Water Tower Wings (1 lb)', description: 'Crispy wings, choice of over 15 sauces', price: 15.99, category: 'Wings' },
            { id: 'wt2', name: 'Tower Burger', description: 'Double patty with cheddar, bacon, and special sauce', price: 17.99, category: 'Burgers' },
            { id: 'wt3', name: 'Fish & Chips', description: 'Beer-battered haddock with fries and coleslaw', price: 17.99, category: 'Mains' },
            { id: 'wt4', name: 'Poutine', description: 'Hand-cut fries, cheese curds, and gravy', price: 11.99, category: 'Sides' },
            { id: 'wt5', name: 'Loaded Nachos', description: 'Piled with beef, cheese, salsa, sour cream, and jalapeños', price: 16.99, category: 'Appetizers' },
        ],
    },

    // ─── Paesano's Food ──────────────────────────────────────
    {
        id: 'paesanos-food', name: "Paesano's Food", category: 'Marketplace', categoryId: 'marketplace',
        image: '/restaurants/paesanos.png', coverColor: '#1a0a08', logo: '🍝',
        rating: 4.8, reviewCount: 380, deliveryTime: '25-40', distance: 3.0, promo: null, isOpen: true, isFeatured: true,
        address: 'Sault Ste. Marie, ON',
        description: "A Soo institution for authentic Italian food. Fresh pasta, homemade sauces, prepared meals, and imported Italian goods — crafted with generations of family tradition.",
        menu: [
            { id: 'pae1', name: 'Fresh Fettuccine (500g)', description: 'Hand-cut daily, ready to cook', price: 8.99, category: 'Fresh Pasta' },
            { id: 'pae2', name: 'Fresh Rigatoni (500g)', description: 'Bronze-die cut, hearty and rustic', price: 8.99, category: 'Fresh Pasta' },
            { id: 'pae3', name: 'Marinara Sauce (750ml)', description: 'San Marzano tomatoes, slow-simmered all day', price: 9.99, category: 'Sauces' },
            { id: 'pae4', name: 'Bolognese Sauce (750ml)', description: 'Rich meat sauce, traditional recipe', price: 12.99, category: 'Sauces' },
            { id: 'pae5', name: 'Homemade Lasagna (Family)', description: 'Feeds 4-6, ready to bake, layers of pasta, meat, and cheese', price: 24.99, category: 'Prepared Meals' },
            { id: 'pae6', name: 'Italian Sausage (4 links)', description: 'Mild or hot, house-made with fennel and herbs', price: 12.99, category: 'Meats' },
            { id: 'pae7', name: 'Tiramisu (whole)', description: 'Classic Italian dessert, serves 6-8', price: 18.99, category: 'Desserts' },
            { id: 'pae8', name: 'Capelletti Soup (1L)', description: 'Traditional broth with house-made stuffed pasta', price: 12.99, category: 'Soups' },
            { id: 'pae9', name: 'Cannoli (4 pack)', description: 'Crispy shells with sweet ricotta filling', price: 10.99, category: 'Desserts' },
            { id: 'pae10', name: 'Meatballs (6 pack)', description: 'House-made with bread crumbs and parmesan', price: 14.99, category: 'Prepared Meals' },
        ],
    },
    ...
    // ─── The Breakfast Pig ──────────────────────────────────────
    {
        ...
        isFeatured: true,
        address: '265 Bruce St, Sault Ste. Marie, ON',
        phone: '+1-705-450-6911',
        hours: 'Mon–Sun 8AM–4PM',
        description: 'All-day breakfast institution on Bruce Street. Locally sourced pork, creative skillets, and the legendary 5-0 — a glazed donut with bacon and cheese. Vegan options available with Beyond sausage and Just Egg.',
        menu: [
            { id: 'bp1', name: 'The Hangover', description: 'Loaded breakfast plate with all the fixings — eggs, bacon, sausage, homefries, toast', price: 20.00, category: 'Keepin\' It Traditional' },
            { id: 'bp2', name: 'This Little Piggy', description: 'Our signature breakfast — peameal, sausage links, eggs, homefries', price: 18.00, category: 'Keepin\' It Traditional' },
            { id: 'bp3', name: 'Basicpig', description: 'Two eggs, choice of meat, homefries, and toast', price: 14.00, category: 'Keepin\' It Traditional' },
            { id: 'bp4', name: 'The Angela', description: 'House specialty with seasonal ingredients — ask your server', price: 18.00, category: 'Distinctively Piggy' },
            { id: 'bp5', name: 'Benny Poutine', description: 'Eggs benny meets poutine — poached eggs, hollandaise, cheese curds, and gravy fries', price: 17.00, category: 'Distinctively Piggy' },
            { id: 'bp6', name: "Nonni's Sugo", description: 'Italian-inspired skillet with sugo sauce, eggs, and fresh herbs', price: 19.00, category: 'Distinctively Piggy' },
            { id: 'bp7', name: 'Classic Benny', description: 'Traditional eggs benedict with back bacon and hollandaise on English muffin', price: 18.00, category: 'Benny A La Pig' },
            { id: 'bp8', name: 'Jalapeno Popper Benny', description: 'Cream cheese stuffed jalapeño, crispy bacon, hollandaise', price: 20.00, category: 'Benny A La Pig' },
            { id: 'bp9', name: 'Hot Honey Pig Mac Skillet', description: 'Mac and cheese skillet with hot honey drizzle and crispy pork', price: 20.00, category: 'Pig Mac Skillets' },
            { id: 'bp10', name: 'Badass Chicken Waffles', description: 'Crispy fried chicken on Belgian waffle with maple syrup and hot sauce', price: 19.00, category: 'Pancakes, Waffles + French Toast' },
            { id: 'bp11', name: 'Bottomless Coffee', description: 'Fresh brewed — refills all day', price: 3.00, category: 'Drinks' },
            { id: 'bp12', name: 'Mimosa', description: 'Classic brunch mimosa with fresh OJ', price: 7.00, category: 'Drinks' },
        ],
    },

    // ─── Georgie's Shawarma ──────────────────────────────────────
    {
        id: 'georgies-shawarma',
        name: "Georgie's Shawarma",
        category: 'Middle Eastern',
        categoryId: 'middle-eastern',
        image: '/restaurants/georgies.png',
        coverColor: '#1a2a1a',
        logo: '🧆',
        rating: 4.7,
        reviewCount: 640,
        ...
        isOpen: true,
        isFeatured: true,
        address: '75 Elgin St, Sault Ste. Marie, ON',
        phone: '+1-705-946-0444',
        hours: 'Mon–Sat 11:30AM–7:30PM, Sun Closed',
        description: 'Authentic Syrian cuisine in the heart of downtown. Everything made from scratch — from the freshly baked flatbread to the silky hummus. A Sault institution for Middle Eastern food.',
        menu: [
            { id: 'gs1', name: 'Traditional Shawarma', description: 'Slow-roasted chicken thigh with garlic sauce, pickled cucumber, and pomegranate molasses in fresh saj bread', price: 14.99, category: 'Wraps' },
            { id: 'gs2', name: 'Untraditional Shawarma', description: 'With hummus, lettuce, tomato, onion, pickled turnip, and cucumber', price: 14.99, category: 'Wraps' },
            { id: 'gs3', name: 'Falafel Wrap', description: 'House-made falafel with tahini, pickles, and fresh veggies in saj bread', price: 12.99, category: 'Wraps' },
            { id: 'gs4', name: 'Shawarma Over Rice', description: 'Generous portion of shawarma over seasoned basmati with salad', price: 16.99, category: 'Plates' },
            { id: 'gs5', name: 'Chicken Kabab Plate', description: 'Grilled chicken kabab with rice, salad, hummus, and pita', price: 17.99, category: 'Plates' },
            { id: 'gs6', name: 'Falafel Plate', description: 'Falafel fritters with rice, salad, hummus, and pickles', price: 14.99, category: 'Plates' },
            { id: 'gs7', name: 'Hummus', description: 'House-made chickpea hummus — creamy, garlicky, perfect with pita', price: 7.99, category: 'Appetizers' },
            { id: 'gs8', name: 'Baba Ghanoush', description: 'Roasted eggplant dip with tahini and lemon', price: 8.99, category: 'Appetizers' },
            { id: 'gs9', name: "Za'atar Manakeesh", description: 'House-made bread topped with za\'atar herbs, olive oil, and spices', price: 6.99, category: 'Appetizers' },
            { id: 'gs10', name: 'Lentil Soup', description: 'Warm, hearty red lentil soup with cumin and lemon', price: 6.99, category: 'Soups' },
            { id: 'gs11', name: 'Baklava', description: 'Flaky phyllo pastry with pistachios and honey syrup', price: 4.99, category: 'Desserts' },
            { id: 'gs12', name: 'Beef Shawarma Bowl', description: 'Slow-roasted beef shawarma over rice with toppings', price: 17.99, category: 'Bowls' },
        ],
    },

    // ─── Northern Superior Brewing Company ──────────────────────────────────────
    {
        id: 'northern-superior-brewing',
        name: 'Northern Superior Brewing Company',
        category: 'Brewery',
        categoryId: 'brewery',
        image: '/restaurants/northern-superior.png',
        coverColor: '#0a1628',
        logo: '🍺',
        rating: 4.6,
        reviewCount: 310,
        ...
        isOpen: true,
        isFeatured: true,
        address: '50 Pim St, Sault Ste. Marie, ON',
        phone: '+1-705-942-2337',
        hours: 'Wed–Thu 4PM–9PM, Fri 2PM–10PM, Sat 12PM–10PM, Sun 12PM–6PM',
        description: 'Brewing in the Soo since 1907. The oldest craft brewery in Northern Ontario — heritage lagers, bold IPAs, and taproom bites. Available across Ontario at LCBO and select grocery stores.',
        menu: [
            { id: 'nsb1', name: 'Northern Superior Lager', description: 'The flagship — crisp, clean, and perfectly balanced', price: 7.50, category: 'On Tap' },
            { id: 'nsb2', name: 'Gitche Gumee Northern IPA', description: 'Bold Northern IPA with citrus hops and a bitter finish', price: 8.00, category: 'On Tap' },
            { id: 'nsb3', name: 'Red Maple Irish Ale', description: 'Smooth Irish-style ale with caramel malt and a dry finish', price: 7.50, category: 'On Tap' },
            { id: 'nsb4', name: 'Northern 55 Amber Lager', description: 'Amber lager with toasted malt character — our heritage recipe', price: 7.50, category: 'On Tap' },
            { id: 'nsb5', name: '11 PM Lager', description: 'Traditional German schwarzbier — dark, smooth, and sessionable', price: 7.50, category: 'On Tap' },
            { id: 'nsb6', name: 'Northern Lights Pilsner', description: 'Light, refreshing, and perfectly hopped pilsner', price: 7.50, category: 'On Tap' },
            { id: 'nsb7', name: 'Hound Town Golden Ale', description: 'Easy-drinking golden ale — perfect for any occasion', price: 7.50, category: 'On Tap' },
            { id: 'nsb8', name: '17 North Pale Ale', description: 'American-style pale ale with tropical and pine notes', price: 8.00, category: 'On Tap' },
            { id: 'nsb9', name: 'Sourdough Pretzels', description: 'Warm pretzels with house-made beer cheese or mustard', price: 12.00, category: 'Taproom Bites' },
            { id: 'nsb10', name: 'Dogos', description: 'Gourmet hot dogs with ketchup, mustard, or beer cheese', price: 10.00, category: 'Taproom Bites' },
            { id: 'nsb11', name: 'Tap Room Charcuterie Board', description: 'Curated board with local meats, cheeses, pickles, and crackers', price: 22.00, category: 'Taproom Bites' },
            { id: 'nsb12', name: 'Marinated Olives', description: 'House-marinated olives with herbs and citrus', price: 8.00, category: 'Taproom Bites' },
        ],
    },
    ...
    // ─── The Country Way ──────────────────────────────────────
    {
        ...
        categoryId: 'health',
        image: '/restaurants/country-way.png',
        coverColor: '#1a2e1a',
        logo: '🌿',
        rating: 4.9,
        reviewCount: 450,
        ...
        isOpen: true,
        isFeatured: true,
        address: '79 Brock St, Sault Ste. Marie, ON',
        phone: '+1-705-256-9988',
        hours: 'Mon–Fri 9:30AM–5:30PM, Sat 9:30AM–5PM, Sun Closed',
        description: 'Downtown health institution since 1974 — 50 years of trusted natural health expertise. Certified Natural Health Practitioners on staff. Vitamins, supplements, organic food, locally sourced products, and natural beauty care.',
        menu: [
            { id: 'cw1', name: 'Health First Multivitamin', description: 'Made-in-Canada daily multivitamin — non-GMO, gluten-free', price: 29.99, category: 'Vitamins & Supplements' },
            { id: 'cw2', name: 'Vitamin D3 (1000 IU)', description: 'Essential for Northern Ontario winters — Canadian-made', price: 14.99, category: 'Vitamins & Supplements' },
            { id: 'cw3', name: 'Omega-3 Fish Oil', description: 'High-potency, wild-caught, molecular distilled', price: 24.99, category: 'Vitamins & Supplements' },
            { id: 'cw4', name: 'Probiotic Complex', description: '50 billion CFU, shelf-stable, multi-strain', price: 34.99, category: 'Vitamins & Supplements' },
            { id: 'cw5', name: 'Organic Trail Mix (300g)', description: 'Locally sourced nuts, seeds, and dried fruit blend', price: 8.99, category: 'Organic Foods' },
            { id: 'cw6', name: 'Raw Honey (500g)', description: 'Local Northern Ontario wildflower honey, unpasteurized', price: 12.99, category: 'Organic Foods' },
            { id: 'cw7', name: 'Organic Peanut Butter (500g)', description: 'Single-ingredient, freshly ground organic peanuts', price: 9.99, category: 'Organic Foods' },
            { id: 'cw8', name: 'Collagen Peptides (300g)', description: 'Grass-fed, hydrolyzed collagen powder for joints and skin', price: 39.99, category: 'Supplements' },
            { id: 'cw9', name: 'Lavender Essential Oil (15ml)', description: 'Pure therapeutic-grade lavender from Canadian farms', price: 16.99, category: 'Natural Beauty' },
            { id: 'cw10', name: 'Charcoal Face Wash', description: 'Activated charcoal cleanser, natural and gentle', price: 14.99, category: 'Natural Beauty' },
            { id: 'cw11', name: 'Organic Green Tea (20 bags)', description: 'Premium loose-leaf quality green tea in pyramid bags', price: 7.99, category: 'Organic Foods' },
            { id: 'cw12', name: 'Protein Bar Box (12 pack)', description: 'Plant-based, gluten-free, no artificial sweeteners', price: 29.99, category: 'Snacks' },
        ],
    },

    // ─── Northern Natural Health & Wellness ──────────────────────────────────────
    {
        id: 'northern-natural-health',
        name: 'Northern Natural Health & Wellness',
        category: 'Health & Wellness',
        categoryId: 'health',
        image: '/restaurants/northern-natural.png',
        coverColor: '#0e2a0e',
        logo: '🍃',
        rating: 4.7,
        reviewCount: 280,
        ...
        description: 'Vitamins, supplements, organic snacks, and locally sourced wellness products. Modern natural health store serving the Sault community with trusted brands and expert advice.',
        menu: [
            { id: 'nnh1', name: 'Elderberry Immune Syrup (250ml)', description: 'Organic elderberry extract with raw honey and ginger', price: 19.99, category: 'Immune Support' },
            { id: 'nnh2', name: 'Magnesium Bisglycinate', description: 'High-absorption magnesium for sleep and muscle recovery', price: 22.99, category: 'Vitamins & Supplements' },
            { id: 'nnh3', name: 'Organic Turmeric Capsules', description: 'Anti-inflammatory turmeric with black pepper for absorption', price: 24.99, category: 'Vitamins & Supplements' },
            { id: 'nnh4', name: 'Local Beeswax Lip Balm (3 pack)', description: 'Handmade with local beeswax, coconut oil, and vitamin E', price: 9.99, category: 'Natural Beauty' },
            { id: 'nnh5', name: 'Organic Apple Cider Vinegar (500ml)', description: 'Raw, unfiltered, with the mother — locally bottled', price: 8.99, category: 'Organic Foods' },
            { id: 'nnh6', name: 'Ashwagandha Root Extract', description: 'Adaptogenic herb for stress and energy — organic certified', price: 27.99, category: 'Supplements' },
            { id: 'nnh7', name: 'Vegan Protein Powder (750g)', description: 'Plant-based blend of pea, hemp, and brown rice protein', price: 34.99, category: 'Sports Nutrition' },
            { id: 'nnh8', name: 'Organic Chia Seeds (500g)', description: 'Omega-rich power seeds, certified organic', price: 11.99, category: 'Organic Foods' },
            { id: 'nnh9', name: 'CBD Oil (30ml)', description: 'Full-spectrum CBD for pain and anxiety relief — third-party tested', price: 49.99, category: 'Wellness' },
            { id: 'nnh10', name: 'Herbal Sleep Tea Blend', description: 'Chamomile, valerian root, and passionflower — caffeine-free', price: 12.99, category: 'Teas' },
        ],
    },
    ...
    // ─── Chummy's Grill ──────────────────────────────────────
    {
        ...
        name: "Chummy's Grill",
        category: 'Indigenous',
        categoryId: 'indigenous',
        image: '/restaurants/chummys.png',
        coverColor: '#2d1f0e',
        logo: '🪶',
        rating: 4.6,
        reviewCount: 390,
        ...
        isFeatured: true,
        address: '262 Frontenac St, Sault Ste. Marie, ON',
        phone: '+1-705-575-3449',
        hours: 'Mon–Sun 9AM–8PM',
        description: 'Located on Batchewana First Nation territory. Comforting Indigenous and Canadian cuisine in a rustic setting adorned with traditional carvings. Famous for Indian Tacos, the Growling Grizzly Burger, and legendary Friday fish-fry nights.',
        menu: [
            { id: 'cg1', name: 'Indian Taco', description: 'Iconic frybread topped with seasoned beef, lettuce, tomato, cheese, and sour cream', price: 13.75, category: 'Chummy\'s Classics' },
            { id: 'cg2', name: 'Grandfather Burger', description: 'Double patty loaded with bacon, cheese, onion rings, and special sauce', price: 17.75, category: 'Burgers' },
            { id: 'cg3', name: 'Grandmother Burger', description: 'Classic burger with all the fixings — lettuce, tomato, onion, pickles', price: 16.75, category: 'Burgers' },
            { id: 'cg4', name: 'Chief Burger', description: 'Triple patty beast with the works', price: 17.75, category: 'Burgers' },
            { id: 'cg5', name: 'White Fish Dinner', description: 'Fresh Lake Superior whitefish, beer-battered and fried golden', price: 17.00, category: 'Fish Fry' },
            { id: 'cg6', name: 'Lake Trout Dinner', description: 'Lake trout fillet with fries and coleslaw', price: 17.00, category: 'Fish Fry' },
            { id: 'cg7', name: 'Chicken Wings', description: 'A pound of wings in your choice of sauce', price: 16.25, category: 'Chummy\'s Classics' },
            { id: 'cg8', name: 'Chicken Fingers and Fries', description: 'Hand-breaded chicken tenders with golden fries', price: 15.25, category: 'Chummy\'s Classics' },
            { id: 'cg9', name: 'Hickory Smoked Pulled Pork', description: 'Slow-smoked pulled pork with BBQ sauce on a brioche bun', price: 16.50, category: 'Chummy\'s Classics' },
            { id: 'cg10', name: 'Hot Sandwich', description: 'Open-faced hot sandwich with gravy and fries', price: 16.50, category: 'Chummy\'s Classics' },
            { id: 'cg11', name: 'Tomato Macaroni Soup', description: 'Chummy\'s famous homemade tomato macaroni soup', price: 5.75, category: 'Soups' },
            { id: 'cg12', name: 'Pancake Breakfast', description: 'Fluffy pancakes with butter and maple syrup', price: 7.25, category: 'Breakfast' },
        ],
    },
];
...
export const shopPartners = [
    {
        ...
        type: 'pharmacy',
        emoji: '💊',
        tagline: 'Your Neighbourhood Pharmacy Since 1962',
        description: 'Locally owned and operated, IDA Drug Mart has been serving Sault Ste. Marie families for over 60 years. Four convenient locations across the city — each offering full pharmacy services, health & wellness, beauty, and everyday essentials. Not a chain. Family-run. Community-first.',
        heroColor: '#0066FF',
        heroGradient: 'linear-gradient(135deg, #0066FF, #0044CC)',
        tags: ['Pharmacy', 'Health & Wellness', 'Beauty', 'Local', 'Family-Owned'],
        badge: 'Est. 1962',
        featured: true,
        locations: [
            {
                id: 'ida-urban-square',
                name: 'Urban Square Drug Mart',
                shortName: 'Urban Square',
                address: '197 Trunk Rd',
                city: 'Sault Ste. Marie, ON',
                postal: 'P6A 3S5',
                phone: '705-759-4818',
                lat: 46.5180,
                lng: -84.3296,
                hours: { weekday: '9:00 AM – 8:00 PM', saturday: '9:00 AM – 6:00 PM', sunday: '10:00 AM – 5:00 PM' },
                features: ['Full Pharmacy', 'Sweet Greetings', 'Coffee Bar', 'Photo Lab'],
                emoji: '🏪',
            },
            {
                id: 'ida-wellington-square',
                name: 'Wellington Square Drug Mart',
                shortName: 'Wellington Square',
                ...
                lng: -84.3105,
                hours: { weekday: '9:00 AM – 8:00 PM', saturday: '9:00 AM – 6:00 PM', sunday: '10:00 AM – 5:00 PM' },
                features: ['Full Pharmacy', 'Sweet Greetings', 'Drive-Through Rx'],
                emoji: '🏬',
            },
            {
                id: 'ida-queenstown',
                name: 'Queenstown Drug Mart',
                shortName: 'Queenstown',
                address: 'Queenstown Area',
                city: 'Sault Ste. Marie, ON',
                postal: '',
                phone: '705-949-7331',
                lat: 46.5050,
                lng: -84.3420,
                hours: { weekday: '9:00 AM – 7:00 PM', saturday: '9:00 AM – 5:00 PM', sunday: 'Closed' },
                features: ['Full Pharmacy', 'Sweet Greetings', 'Home Healthcare'],
                emoji: '🏥',
            },
            {
                id: 'ida-market-mall',
                name: 'Market Mall Pharmacy',
                shortName: 'Market Mall',
                address: '180-275 Second Line W',
                city: 'Sault Ste. Marie, ON',
                postal: 'P6C 6G1',
                phone: '705-254-7329',
                lat: 46.5310,
                lng: -84.3580,
                hours: { weekday: '9:00 AM – 9:00 PM', saturday: '9:00 AM – 6:00 PM', sunday: '11:00 AM – 5:00 PM' },
                features: ['Full Pharmacy', 'Sweet Greetings', 'Coffee Bar', 'Cosmetics Counter'],
                emoji: '🛍️',
            },
        ],
        categories: [
            { name: 'Pharmacy', emoji: '💊', desc: 'Prescriptions, vaccinations, health consultations' },
            { name: 'Health & Wellness', emoji: '🌿', desc: 'Vitamins, supplements, natural health products' },
            { name: 'Beauty & Skincare', emoji: '💄', desc: 'Cosmetics, skincare, hair care, personal care' },
            { name: 'Baby & Kids', emoji: '👶', desc: 'Diapers, formula, baby care essentials' },
            { name: 'Snacks & Drinks', emoji: '🥤', desc: 'Chips, candy, beverages, grab-and-go' },
            { name: 'Household', emoji: '🏠', desc: 'Cleaning supplies, paper products, batteries' },
        ],
    },
    {
        id: 'sweet-greetings',
        name: 'Sweet Greetings',
        slug: 'sweet-greetings',
        type: 'gifts',
        emoji: '🎁',
        tagline: 'Gifts, Chocolates & Local Treasures',
        description: 'A beloved gift shop nestled inside IDA Drug Marts across the Sault. Sweet Greetings specializes in custom gift baskets, gourmet chocolates, artisanal coffees, home decor, and curated gifts from local makers like Moon & Mana, OC Hair & Bath, and Hogan\'s Homestead. Perfect for every occasion — from birthdays to thank-yous.',
        heroColor: '#ec4899',
        heroGradient: 'linear-gradient(135deg, #ec4899, #db2777)',
        tags: ['Gift Baskets', 'Chocolates', 'Coffee Bar', 'Home Decor', 'Local Makers'],
        badge: 'Shop-in-Shop',
        featured: true,
        parentId: 'ida-drug-mart',
        locations: ['ida-urban-square', 'ida-wellington-square', 'ida-queenstown', 'ida-market-mall'],
        coffeeBars: ['ida-urban-square', 'ida-market-mall'],
        categories: [
            { name: 'Gift Baskets', emoji: '🧺', desc: 'Custom baskets for any occasion' },
            { name: 'Gourmet Chocolates', emoji: '🍫', desc: 'Premium chocolates and confections' },
            { name: 'Coffee Bar', emoji: '☕', desc: 'Artisanal coffees at Market Mall & Urban Square' },
            { name: 'Home Decor', emoji: '🏡', desc: 'Candles, throws, kitchenware by Danica & Now Design' },
            { name: 'Local Makers', emoji: '🌙', desc: 'Moon & Mana, OC Hair, Hogan\'s Homestead, and more' },
            { name: 'Cards & Wrap', emoji: '💌', desc: 'Greeting cards and gift wrapping services' },
        ],
    },
];

export const getShopPartnerById = (id) => {
    return shopPartners.find(p => p.id === id);
};
