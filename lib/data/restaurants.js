...
export const categories = [
    ...
    { id: 'craft-cafe', name: 'Craft & Café', emoji: '🧶' },
    { id: 'winery', name: 'Winery', emoji: '🍷' },
];
...
export const restaurants = [
    ...
    {
        id: 'embers-ridge',
        name: 'Embers On The Ridge',
        category: 'Fine Dining',
        categoryId: 'fine-dining',
        image: '/restaurants/embers.png',
        coverColor: '#1a0a08',
        logo: '🔥',
        rating: 4.8,
        reviewCount: 363,
        ...
        phone: '+1-705-253-2002',
        hours: 'Wed–Sun 5PM–9PM (seasonal)',
        description: 'Elevated farm-to-table dining overlooking Crimson Ridge Golf Course. Dry-aged Penokean Hills beef, house-smoked seafood, seasonal menus, and curated wines. The premium dining experience of Northern Ontario.',
        menu: [
            { id: 'er1', name: 'Dry-Aged Ribeye (14oz)', description: 'Penokean Hills farm dry-aged ribeye, roasted garlic butter, seasonal sides', price: 58.00, category: 'Mains' },
            { id: 'er2', name: 'Prime Rib', description: 'Slow-roasted prime rib with Yorkshire pudding and au jus', price: 48.00, category: 'Mains' },
            { id: 'er3', name: 'House-Smoked Salmon', description: 'In-house smoked Atlantic salmon with capers, crème fraiche, and crostini', price: 22.00, category: 'Appetizers' },
            { id: 'er4', name: 'Mediterranean Pesto Flatbread', description: 'Wood-fired flatbread with basil pesto, sundried tomato, and goat cheese', price: 18.00, category: 'Appetizers' },
            { id: 'er5', name: 'Mussels in Smoked Tomato Broth', description: 'PEI mussels steamed in house-smoked tomato broth with grilled bread', price: 19.00, category: 'Appetizers' },
            { id: 'er6', name: 'Rack of Lamb', description: 'New Zealand rack with rosemary jus', price: 42.99, category: 'Mains' },
            { id: 'er7', name: 'Duck Breast', description: 'Pan-seared with cherry reduction', price: 36.99, category: 'Mains' },
            { id: 'er8', name: 'Applewood Smoked Ribs', description: 'St. Louis style ribs, slow-smoked with house-made BBQ glaze', price: 36.00, category: 'Mains' },
            { id: 'er9', name: 'Crème Brûlée', description: 'Classic vanilla bean crème brûlée with seasonal berries', price: 14.00, category: 'Desserts' },
            { id: 'er10', name: 'Signature Cocktail', description: 'Rotating seasonal craft cocktail — ask your server', price: 16.00, category: 'Drinks' },
        ],
    },
    ...
    // ─── 49th Apparel ──────────────────────────────────────
    {
        ...
        category: 'Boutique',
        categoryId: 'boutique',
        image: '/restaurants/49th-apparel.png',
        coverColor: '#1a1a2e',
        logo: '🪡',
        rating: 4.8,
        reviewCount: 210,
        ...
        isOpen: true,
        isFeatured: true,
        address: '480 Queen St E, Sault Ste. Marie, ON',
        hours: 'By appointment / Online',
        description: 'Canadian-made sleepwear and womenswear designed and produced right here in the Sault. Natural fabrics — cotton, linen, hemp. Small-batch, locally manufactured. Pickup by appointment at the Queen St studio.',
        menu: [
            { id: '49a1', name: 'Sleep Shorts', description: 'Lightweight cotton sleep shorts — perfect for summer', price: 35.00, category: 'Sleepwear' },
            { id: '49a2', name: 'Men\'s Slim Boxer Pants', description: 'Relaxed-fit boxer pants in soft cotton', price: 62.00, category: 'Sleepwear' },
            { id: '49a3', name: 'Classic Nightshirt', description: 'Knee-length nightshirt in premium cotton or linen', price: 125.00, category: 'Sleepwear' },
            { id: '49a4', name: 'Women\'s Classic Pajama Set', description: 'Button-up top and pants in natural cotton — designed in the Soo', price: 159.00, category: 'Sleepwear' },
            { id: '49a5', name: 'Ethel Housecoat', description: 'Full-length robe in luxurious natural fabric', price: 149.00, category: 'Robes' },
            { id: '49a6', name: 'Linen Sleep Shorts', description: 'European linen sleep shorts — breathable and elegant', price: 68.00, category: 'Sleepwear' },
            { id: '49a7', name: 'Hemp Blend Tee', description: 'Relaxed-fit tee in sustainable hemp cotton blend', price: 48.00, category: 'Womenswear' },
            { id: '49a8', name: 'Core Collection Dress', description: 'Seasonless cotton dress — minimal, tailored, Canadian-made', price: 120.00, category: 'Womenswear' },
            { id: '49a9', name: 'Upcycled Wool Scarf', description: 'One-of-a-kind scarf from upcycled wool', price: 45.00, category: 'Accessories' },
            { id: '49a10', name: 'Gift Card', description: 'Give the gift of locally made apparel', price: 50.00, category: 'Gifts' },
        ],
    },

    // ─── Sunset Noodle House ──────────────────────────────────────
    {
        id: 'sunset-noodle-house',
        name: 'Sunset Noodle House',
        category: 'Vietnamese',
        categoryId: 'vietnamese',
        image: '/restaurants/sunset-noodle.png',
        coverColor: '#2e1a0a',
        logo: '🍜',
        rating: 4.5,
        reviewCount: 480,
        ...
        isOpen: true,
        isFeatured: true,
        address: '133 Spring St, Sault Ste. Marie, ON',
        phone: '+1-705-759-0000',
        hours: 'Tue–Thu 11:30AM–10PM, Fri 11:30AM–11PM, Sat 5PM–11PM',
        description: 'Authentic Vietnamese cuisine on Spring Street. Steaming bowls of pho, crispy banh mi, and fresh vermicelli bowls. A Soo favourite for Southeast Asian comfort food.',
        menu: [
            { id: 'snh1', name: 'Pho Dac Biet (Special Pho)', description: 'Loaded special pho with ribeye beef, brisket, and flank in aromatic broth', price: 18.99, category: 'Pho' },
            { id: 'snh2', name: 'Pho Ga (Chicken Pho)', description: 'Traditional chicken pho with rice noodles and fresh herbs', price: 16.99, category: 'Pho' },
            { id: 'snh3', name: 'Pho Chay (Vegetarian Pho)', description: 'Tofu and cabbage in vegetable broth with rice noodles', price: 15.99, category: 'Pho' },
            { id: 'snh4', name: 'Bánh Mì Classic Ham', description: 'Vietnamese baguette with ham, pickled veggies, cilantro, and jalapeño', price: 12.00, category: 'Bánh Mì' },
            { id: 'snh5', name: 'Bánh Mì Pork Belly', description: 'Grilled pork belly sandwich with daikon, carrot, and sriracha mayo', price: 14.00, category: 'Bánh Mì' },
            { id: 'snh6', name: 'Vermicelli Bowl', description: 'Rice vermicelli with grilled meat, spring rolls, peanuts, and fish sauce', price: 16.99, category: 'Bowls' },
            { id: 'snh7', name: 'Pad Thai', description: 'Stir-fried rice noodles with shrimp, peanuts, bean sprouts, and tamarind', price: 17.99, category: 'Noodles' },
            { id: 'snh8', name: 'Fresh Spring Rolls (4pc)', description: 'Rice paper rolls with shrimp, rice noodles, herbs, and peanut sauce', price: 10.99, category: 'Appetizers' },
            { id: 'snh9', name: 'Vietnamese Iced Coffee', description: 'Strong drip coffee with sweetened condensed milk over ice', price: 5.99, category: 'Drinks' },
            { id: 'snh10', name: 'Tom Yum Soup', description: 'Spicy and sour Thai-inspired soup with shrimp and mushrooms', price: 14.99, category: 'Soups' },
            { id: 'snh11', name: 'Mango Sticky Rice', description: 'Sweet coconut sticky rice with fresh mango slices', price: 8.99, category: 'Desserts' },
            { id: 'snh12', name: 'Bánh Mì Grilled Cheese', description: 'Ultimate grilled cheese on Vietnamese baguette', price: 12.00, category: 'Bánh Mì' },
        ],
    },
    ...
    {
        id: 'scott-coffee-co',
        name: 'Scott Coffee Co.',
        category: 'Café',
        categoryId: 'cafe',
        image: '/restaurants/scott-coffee.png',
        coverColor: '#1a0e08',
        logo: '☕',
        rating: 4.7,
        reviewCount: 340,
        ...
        isOpen: true,
        isFeatured: true,
        address: '248 Northern Ave E, Sault Ste. Marie, ON',
        hours: 'Mon–Sat 7AM–4PM, Sun Closed',
        description: 'Specialty espresso, homemade sweets, and cozy vibes. Famous for their cheesecakes and brownies. Vietnamese-style ca phe sua da and London Fogs with oat milk. A local\'s morning ritual.',
        menu: [
            { id: 'sc1', name: 'Espresso', description: 'Double-shot pulled from house-roasted beans', price: 3.50, category: 'Coffee' },
            { id: 'sc2', name: 'Oat Milk Latte', description: 'Silky espresso with steamed oat milk', price: 5.50, category: 'Coffee' },
            { id: 'sc3', name: 'Ca Phe Sua Da', description: 'Vietnamese iced coffee with sweetened condensed milk', price: 6.00, category: 'Coffee' },
            { id: 'sc4', name: 'London Fog', description: 'Earl Grey tea latte with vanilla and oat milk', price: 5.50, category: 'Tea' },
            { id: 'sc5', name: 'Cold Brew', description: 'Smooth, slow-steeped cold brew on ice', price: 5.00, category: 'Coffee' },
            { id: 'sc6', name: 'Homemade Cheesecake (slice)', description: 'Legendary house-made cheesecake — flavour rotates weekly', price: 7.99, category: 'Sweets' },
            { id: 'sc7', name: 'Triple Chocolate Brownie', description: 'Dense, fudgy brownie with three types of chocolate', price: 5.99, category: 'Sweets' },
            { id: 'sc8', name: 'Cinnamon Bun', description: 'Warm, gooey cinnamon bun with cream cheese icing', price: 5.99, category: 'Sweets' },
            { id: 'sc9', name: 'Breakfast Sandwich', description: 'Egg, cheese, and bacon on a fresh croissant', price: 8.99, category: 'Food' },
            { id: 'sc10', name: 'Avocado Toast', description: 'Smashed avocado on sourdough with everything seasoning', price: 9.99, category: 'Food' },
        ],
    },
    ...
    // ─── Stork & Bundle ──────────────────────────────────────
    {
        ...
        category: 'Boutique',
        categoryId: 'boutique',
        image: '/restaurants/stork-bundle.png',
        coverColor: '#f5e6d3',
        logo: '👶',
        rating: 4.9,
        reviewCount: 190,
        ...
        isOpen: true,
        isFeatured: true,
        address: '715 Queen St E, Sault Ste. Marie, ON',
        hours: 'Mon–Sat 10AM–5PM, Sun Closed',
        description: 'Curated baby gear, eco-friendly products, cloth diapers, organic clothing, strollers, and toys. Top-quality, functional, and durable products for new parents. A Sault Ste. Marie favourite since day one.',
        menu: [
            { id: 'sb1', name: 'Cloth Diaper Starter Kit', description: 'Everything you need to start cloth diapering — covers, inserts, and wet bag', price: 89.99, category: 'Essentials' },
            { id: 'sb2', name: 'Organic Cotton Onesie (3-pack)', description: 'GOTS-certified organic cotton bodysuits', price: 34.99, category: 'Clothing' },
            { id: 'sb3', name: 'Bamboo Muslin Swaddle (2-pack)', description: 'Ultra-soft bamboo muslin swaddle blankets', price: 29.99, category: 'Essentials' },
            { id: 'sb4', name: 'Green Toys Stacking Cups', description: '100% recycled plastic stacking cups — made in USA', price: 14.99, category: 'Toys' },
            { id: 'sb5', name: 'Natural Teething Ring', description: 'Maple wood teething ring with organic cotton bunny ears', price: 16.99, category: 'Toys' },
            { id: 'sb6', name: 'Organic Baby Shampoo (250ml)', description: 'Gentle, tear-free, plant-based formula', price: 12.99, category: 'Bath & Body' },
            { id: 'sb7', name: 'Nursing Pillow', description: 'Ergonomic support pillow with removable organic cotton cover', price: 54.99, category: 'Essentials' },
            { id: 'sb8', name: 'Baby Carrier', description: 'Ergonomic carrier for newborns to toddlers — all-position', price: 129.99, category: 'Gear' },
            { id: 'sb9', name: 'Organic Diaper Cream (100g)', description: 'Zinc-based, natural diaper rash cream', price: 15.99, category: 'Bath & Body' },
            { id: 'sb10', name: 'Gift Bundle — New Baby', description: 'Curated gift box: onesie, swaddle, teether, and card', price: 64.99, category: 'Gifts' },
        ],
    },

    // ─── Soo Falls Brewing Company ──────────────────────────────────────
    {
        id: 'soo-falls-brewing',
        name: 'Soo Falls Brewing Company',
        category: 'Brewery',
        categoryId: 'brewery',
        image: '/restaurants/soo-falls.png',
        coverColor: '#0e1a28',
        logo: '🍻',
        rating: 4.5,
        reviewCount: 220,
        ...
        isFeatured: true,
        address: '87 Huron St, Sault Ste. Marie, ON',
        hours: 'Thu–Fri 4PM–10PM, Sat 2PM–10PM, Sun 2PM–7PM',
        description: 'Canal District craft brewery proudly brewing in the Soo. Small-batch lagers, sours, IPAs, and seasonal releases. Taproom with cans to go. 100% locally brewed.',
        menu: [
            { id: 'sfb1', name: 'Light Lager', description: 'Clean, crisp, and easy-drinking session lager', price: 7.00, category: 'On Tap' },
            { id: 'sfb2', name: 'Italian Pilsner', description: 'Dry-hopped with Perle hops — floral and herbal aromas', price: 7.50, category: 'On Tap' },
            { id: 'sfb3', name: 'Irish Red Ale', description: 'Malty, balanced, and smooth with toffee notes', price: 7.50, category: 'On Tap' },
            { id: 'sfb4', name: 'Hazy IPA', description: 'Double dry-hopped with juicy citrus and tropical notes', price: 8.50, category: 'On Tap' },
            { id: 'sfb5', name: 'Dunkelweizen', description: 'Dark wheat beer with clove, banana, and caramel complexity', price: 8.00, category: 'On Tap' },
            { id: 'sfb6', name: 'Shipwreck Sour — SS Cedarville', description: 'Citrus sour ale with orange, grapefruit, and nectarine', price: 8.50, category: 'Seasonal' },
            { id: 'sfb7', name: '4-Pack Mixed Cans', description: 'Rotating mix of 4 cans — brewer\'s choice', price: 22.00, category: 'Take Home' },
            { id: 'sfb8', name: '6-Pack Light Lager', description: 'Six cans of our flagship light lager', price: 18.00, category: 'Take Home' },
            { id: 'sfb9', name: 'Tasting Flight', description: 'Four 5oz pours — pick from what\'s on tap', price: 14.00, category: 'Taproom' },
            { id: 'sfb10', name: 'Growler Fill (1.89L)', description: 'Fill your growler with any beer on tap', price: 16.00, category: 'Take Home' },
        ],
    },
    ...
    {
        id: 'shabby-motley',
        name: 'Shabby Motley Handcraft',
        category: 'Craft & Café',
        categoryId: 'craft-cafe',
        image: '/restaurants/shabby-motley.png',
        coverColor: '#2e1a2e',
        logo: '🧶',
        rating: 4.6,
        reviewCount: 160,
        ...
        isOpen: true,
        isFeatured: false,
        address: '356 Queen St E, Sault Ste. Marie, ON',
        hours: 'Tue–Sat 10AM–5PM, Sun Closed',
        description: 'Part yarn shop, part café, part maker space. Locally produced handicrafts, textiles, art, and baked goods. Home Bakehouse espresso bar with sourdough, vegan and gluten-free options. Workshops in knitting, dyeing, spinning, and more.',
        menu: [
            { id: 'sm1', name: 'Sourdough Loaf', description: 'Fresh-baked artisan sourdough from Home Bakehouse', price: 8.99, category: 'Bakery' },
            { id: 'sm2', name: 'Espresso', description: 'Double-shot espresso from the Home Bakehouse bar', price: 3.50, category: 'Coffee' },
            { id: 'sm3', name: 'Oat Milk Latte', description: 'Creamy oat milk latte — dairy-free', price: 5.50, category: 'Coffee' },
            { id: 'sm4', name: 'Vegan Muffin', description: 'Daily rotating flavour — plant-based, made in-house', price: 4.99, category: 'Bakery' },
            { id: 'sm5', name: 'Vegetarian Lunch Bowl', description: 'Seasonal veggie bowl with grains, pickled veg, and tahini', price: 14.99, category: 'Lunch' },
            { id: 'sm6', name: 'Gluten-Free Cookie', description: 'House-made GF cookie — flavour changes daily', price: 4.50, category: 'Bakery' },
            { id: 'sm7', name: 'Hand-Dyed Yarn Skein', description: 'Locally dyed merino wool — unique colourways', price: 28.00, category: 'Craft Supplies' },
            { id: 'sm8', name: 'Knitting Needles Set', description: 'Bamboo circular needles — multiple sizes', price: 18.00, category: 'Craft Supplies' },
            { id: 'sm9', name: 'Workshop Gift Card', description: 'Redeemable for any crafting workshop', price: 45.00, category: 'Workshops' },
            { id: 'sm10', name: 'Handmade Tote Bag', description: 'Hand-sewn tote from upcycled fabrics', price: 35.00, category: 'Handmade' },
        ],
    },
    ...
    {
        id: 'annanda-chaga',
        name: 'Annanda Chaga Mushrooms',
        category: 'Health & Wellness',
        categoryId: 'health',
        image: '/restaurants/annanda-chaga.png',
        coverColor: '#1a1a0e',
        logo: '🍄',
        rating: 4.8,
        reviewCount: 140,
        ...
        description: 'Family-owned, wild-harvesting organic Canadian chaga mushrooms from Northern Ontario forests. Superfoods meets wilderness. Tinctures, powders, teas, and mushroom coffees — third-party lab tested.',
        menu: [
            { id: 'ac1', name: 'Wild Chaga Tea Chunks (100g)', description: 'Wild-harvested organic chaga chunks for brewing tea', price: 19.99, category: 'Tea' },
            { id: 'ac2', name: 'Chaga Dual Extract Tincture (30ml)', description: 'Full-spectrum chaga extract — alcohol and water extracted', price: 34.99, category: 'Tinctures' },
            { id: 'ac3', name: 'Triple Mushroom Tincture (30ml)', description: 'Chaga, reishi, and lion\'s mane blend for immunity and focus', price: 39.99, category: 'Tinctures' },
            { id: 'ac4', name: 'Chaga Mushroom Powder (100g)', description: 'Fine-ground chaga for smoothies, lattes, and recipes', price: 24.99, category: 'Powders' },
            { id: 'ac5', name: 'Chaga Coffee (250g)', description: 'Medium roast coffee blended with chaga extract', price: 16.99, category: 'Coffee' },
            { id: 'ac6', name: 'ImmuniTea Blend', description: 'Chaga, elderberry, and echinacea immune-support tea', price: 14.99, category: 'Tea' },
            { id: 'ac7', name: 'Lion\'s Mane Tincture (30ml)', description: 'Organically grown lion\'s mane for cognitive support', price: 29.99, category: 'Tinctures' },
            { id: 'ac8', name: 'Reishi Tincture (30ml)', description: 'Calming reishi mushroom extract for stress and sleep', price: 29.99, category: 'Tinctures' },
            { id: 'ac9', name: 'Chaga Skincare Cream (50ml)', description: 'Antioxidant-rich chaga face cream — natural and organic', price: 28.99, category: 'Skincare' },
            { id: 'ac10', name: 'Sampler Gift Box', description: 'Tea, tincture, and coffee sampler — perfect intro gift', price: 44.99, category: 'Gifts' },
        ],
    },
    ...
    {
        id: 'algoma-highlands',
        name: 'Algoma Highlands Wild Blueberry Farm & Winery',
        category: 'Winery',
        categoryId: 'winery',
        image: '/restaurants/algoma-highlands.png',
        coverColor: '#1a0e2e',
        logo: '🫐',
        rating: 4.7,
        reviewCount: 180,
        ...
        isOpen: true,
        isFeatured: true,
        address: 'Wawa, ON (640-acre farm)',
        hours: 'Mon–Sat 9AM–5PM (seasonal)',
        description: 'Family-owned 640-acre wild blueberry farm and winery on the North Shore of Lake Superior. Wild blueberry wines, artisanal jams, BBQ sauces, syrups, and fresh berries in season. Agri-tourism tours and wine tastings available.',
        menu: [
            { id: 'ah1', name: 'Wild Blueberry Wine (750ml)', description: 'Estate wild blueberry wine — smooth, fruity, and uniquely Northern Ontario', price: 18.99, category: 'Wine' },
            { id: 'ah2', name: 'Strawberry Wine (750ml)', description: 'Light and refreshing strawberry fruit wine', price: 17.99, category: 'Wine' },
            { id: 'ah3', name: 'Wild Blueberry Rhubarb Wine (750ml)', description: 'Tart rhubarb balanced with sweet wild blueberry', price: 18.99, category: 'Wine' },
            { id: 'ah4', name: 'Wild Blueberry Jam (250ml)', description: 'Small-batch jam made from hand-picked wild blueberries', price: 9.99, category: 'Preserves' },
            { id: 'ah5', name: 'Wild Blueberry Jalapeño Jam (250ml)', description: 'Sweet heat — wild blueberries meet jalapeño. Incredible on cheese boards', price: 10.99, category: 'Preserves' },
            { id: 'ah6', name: 'Wild Blueberry BBQ Sauce (350ml)', description: 'Smoky BBQ sauce infused with wild blueberries', price: 11.99, category: 'Sauces' },
            { id: 'ah7', name: 'Wild Blueberry Syrup (250ml)', description: 'Pure wild blueberry syrup for pancakes, waffles, and cocktails', price: 10.99, category: 'Syrups' },
            { id: 'ah8', name: 'Pure Wild Blueberry Juice (1L)', description: '100% wild blueberry juice — no added sugar', price: 14.99, category: 'Juice' },
            { id: 'ah9', name: 'Wine Trio Gift Box', description: 'Three bottles: Blueberry, Strawberry, and Blueberry Rhubarb', price: 49.99, category: 'Gifts' },
            { id: 'ah10', name: 'Fresh Wild Blueberries (quart)', description: 'Seasonal — hand-picked August harvest from our 640-acre farm', price: 8.99, category: 'Fresh (Seasonal)' },
        ],
    },
    ...
    // ─── Aizeneia ──────────────────────────────────────
    {
        ...
        category: 'Boutique',
        categoryId: 'boutique',
        image: '/restaurants/aizeneia.png',
        coverColor: '#0e2e1a',
        logo: '🌱',
        rating: 4.8,
        reviewCount: 95,
        ...
        isOpen: true,
        isFeatured: false,
        address: 'Soo MRKT, 73 Brock St, Sault Ste. Marie, ON',
        hours: 'Saturdays 9AM–2PM (Market) / Online',
        description: 'Handmade zero-waste and self-care products from the Soo Market. Eco-conscious bath, body, and home goods crafted locally. Plastic-free, sustainable, and beautifully packaged — ideal for gifting.',
        menu: [
            { id: 'az1', name: 'Shampoo Bar', description: 'Sulfate-free solid shampoo — plastic-free, lasts 80+ washes', price: 14.99, category: 'Hair Care' },
            { id: 'az2', name: 'Conditioner Bar', description: 'Moisturizing solid conditioner with argan oil', price: 14.99, category: 'Hair Care' },
            { id: 'az3', name: 'Beeswax Food Wraps (3-pack)', description: 'Reusable beeswax wraps — small, medium, large', price: 22.99, category: 'Kitchen' },
            { id: 'az4', name: 'Natural Deodorant', description: 'Aluminum-free, baking soda-free deodorant in compostable tube', price: 12.99, category: 'Body Care' },
            { id: 'az5', name: 'Oatmeal Bath Soak', description: 'Soothing oatmeal and lavender bath soak for sensitive skin', price: 10.99, category: 'Bath' },
            { id: 'az6', name: 'Lip Balm (3-pack)', description: 'Beeswax lip balm trio — vanilla, mint, and honey', price: 12.99, category: 'Body Care' },
            { id: 'az7', name: 'Dish Soap Bar', description: 'Solid dish soap block — zero plastic, cuts through grease', price: 9.99, category: 'Kitchen' },
            { id: 'az8', name: 'Self-Care Gift Box', description: 'Curated box: shampoo bar, lip balm, bath soak, and lotion bar', price: 44.99, category: 'Gifts' },
            { id: 'az9', name: 'Lotion Bar', description: 'Cocoa butter and coconut oil solid lotion — no packaging waste', price: 11.99, category: 'Body Care' },
            { id: 'az10', name: 'Bamboo Toothbrush (2-pack)', description: 'Biodegradable bamboo handle with charcoal bristles', price: 8.99, category: 'Essentials' },
        ],
    },
];
...
export const sooMrktRetailVendors = [
    ...
    {
        id: 'sm-getfresh', name: "Soo Fresh Market", category: 'Grocery', emoji: '🥦',
        ...
        story: 'Soo Fresh Market brings the artisan grocery experience to Sault Ste. Marie — hand-selected produce, imported cheeses, and deli meats cut to order.',
        locationDetail: 'Sault Ste. Marie, ON',
