...
export const fleetRoster = [
    ...
    },
    {
        ...
        tier: ['Soobér Comfort'],
        emoji: '🩶', color: '#636e72',
        heroImage: '/fleet/honda-accord-hybrid.png',
    },
    ...
    },
    {
        ...
        tier: ['Soobér Go'],
        emoji: '🐬', color: '#74b9ff',
        heroImage: '/fleet/byd-dolphin.png',
    },
    {
        ...
        tier: ['Soobér XL'],
        emoji: '🟤', color: '#2d3436',
        heroImage: '/fleet/byd-tang-ev.png',
    },
    {
...
export const popularDestinations = [
    {
        ...
        address: '475 Airport Rd, Sault Ste. Marie, ON P6A 7B4',
        description: 'YAM — Sault Ste. Marie Airport. Serving flights to Toronto (Pearson & Billy Bishop), Sudbury, and Thunder Bay. Pre-book your ride to guarantee a vehicle at arrival.',
        tip: 'Schedule your pickup 30 min before landing for curbside pickup at the arrivals terminal.',
        features: ['Curbside pickup', 'Flight tracking', 'Free 15-min wait', 'Luggage assistance']
    },
    {
        name: 'Station Mall', emoji: '🛍️', estimate: '$8–12',
        address: '293 Bay St, Sault Ste. Marie, ON P6A 1X3',
        description: 'The Soo\'s largest shopping centre with 100+ stores including Walmart, Sport Chek, and local boutiques. Drop-off at the main Bay Street entrance.',
        tip: 'Ask your driver to drop at the south entrance for quick access to food court and Walmart.',
        features: ['Main entrance drop-off', 'Multi-stop shopping trips', 'Wait & return available']
    },
    {
        name: 'GFL Memorial Gardens', emoji: '🏒', estimate: '$10–15',
        address: '269 Queen St W, Sault Ste. Marie, ON P6A 5K4',
        description: 'Home of the Soo Greyhounds OHL team. 5,086 seats. Enhanced Soobér service on game nights — dedicated drivers, arena pickup zones, and 2x Soobér Rewards.',
        tip: 'Use code GOHOUNDS for a free ride on game nights. Book early — demand surges after final whistle!',
        features: ['Game-night fleet', 'Arena pickup zone', 'Post-game surge-free', '2x rewards']
    },
    {
        name: 'Sault Area Hospital', emoji: '🏥', estimate: '$10–18',
        address: '750 Great Northern Rd, Sault Ste. Marie, ON P6B 0A8',
        description: 'Sault Area Hospital — Main entrance and Emergency on Great Northern Rd. CarePass members get priority scheduling and door-to-door assistance.',
        tip: 'CarePass members: add recurring appointments and rides are auto-scheduled. Zero stress.',
        features: ['CarePass priority', 'Door-to-door assist', 'Wheelchair accessible', 'Wait & return']
    },
    {
        name: 'Algoma University', emoji: '🎓', estimate: '$12–20',
        address: '1520 Queen St E, Sault Ste. Marie, ON P6A 2G4',
        description: 'Algoma U campus — drop-off at the main entrance on Queen St E. Students get 15% off every ride with a valid student ID.',
        tip: 'Show your student ID in-app for 15% off every ride + exclusive campus promotions.',
        features: ['Student discount 15%', 'Campus drop-off', 'Late-night safe rides', 'Group rides']
    },
    {
        name: 'Sault College', emoji: '📚', estimate: '$10–16',
        address: '443 Northern Ave, Sault Ste. Marie, ON P6B 4J3',
        description: 'Sault College of Applied Arts & Technology. Main campus on Northern Ave. Serving 4,000+ students with affordable, reliable rides.',
        tip: 'Use Soobér Go for the most affordable rides between campus and downtown.',
        features: ['Student rates', 'Northern Ave pickup', 'Affordable Soobér Go', 'Group booking']
    },
    {
        name: 'Agawa Canyon', emoji: '🏔️', estimate: '$15–22',
        address: 'Agawa Canyon Wilderness Park, Sault Ste. Marie, ON',
        description: 'Agawa Canyon Tour Train departure point. Book a ride to the train station and explore 114 miles of Canadian Shield wilderness. Seasonal: June to October.',
        tip: 'Pre-book your return ride — cell service is limited in the canyon. Add it when you book.',
        features: ['Train station drop-off', 'Pre-book return ride', 'Scenic route option', 'Seasonal']
    },
    {
        name: 'International Bridge', emoji: '🌉', estimate: '$8–14',
        address: 'International Bridge, Sault Ste. Marie, ON',
        description: 'Connecting Sault Ste. Marie, Ontario to Sault Ste. Marie, Michigan. Drop-off at Canadian customs plaza. Passport/NEXUS required for crossing.',
        tip: 'We drop you at the pedestrian entrance on the Canadian side. Have your passport ready!',
        features: ['Customs plaza drop-off', 'Cross-border ready', 'Passport reminder', 'Duty-free access']
    },
];
...
export const safetyFeatures = [
    {
        ...
        details: ['13-vehicle all-electric and hybrid fleet', '7 manufacturers: Cadillac, GMC, Hyundai, Honda, Tesla, BYD, Lamborghini', 'Zero tailpipe emissions on every trip', '42+ tonnes of CO₂ saved annually', 'All vehicles maintained to dealer standards']
    },
    {
        title: 'Verified Drivers', description: 'Background-checked, professionally trained, community-rated.', emoji: '✅',
        details: ['Criminal background check required', 'Completed Soobér Academy training program', 'Minimum 4.8★ community rating maintained', 'Annual defensive driving refresher', 'Local residents only — your neighbours']
    },
    {
        title: 'Real-Time Tracking', description: 'Share your ride with loved ones. GPS tracking on every trip.', emoji: '📍',
        details: ['Live GPS tracking shared with up to 5 contacts', 'Estimated arrival time updates every 30 seconds', 'Route deviation alerts sent automatically', 'Trip history stored securely for 90 days', 'Family dashboard for CarePass members']
    },
    {
        title: 'In-App Safety', description: 'Emergency button, trip recording, and 24/7 support.', emoji: '🛡️',
        details: ['One-tap emergency button connects to 911 + Soobér dispatch', 'Audio recording available on every trip (consent-based)', '24/7 live support — real people, not bots', 'Post-ride safety reports reviewed within 1 hour', 'Anonymous feedback system for sensitive concerns']
    },
    {
        title: 'Fair Pricing', description: 'No surge pricing ever. Transparent fares before you book.', emoji: '💰',
        details: ['Upfront pricing locked before you confirm', 'Zero surge pricing — same rate during Greyhounds games', 'Transparent fare breakdown: base + distance + time', 'Price match guarantee vs. local taxis', 'Student, senior, and CarePass discounts available']
    },
    {
        title: 'Local Drivers', description: 'Your neighbours behind the wheel. Supporting the local economy.', emoji: '🏠',
        details: ['100% locally-hired from Sault Ste. Marie and area', 'Drivers earn competitive wages + tips (100% kept)', 'Vehicle provided by Soobér — no personal car needed', 'Flexible scheduling through Soobér Workforce platform', 'Community engagement: drivers know the best routes and spots']
    },
];
